...
const DAYS: DayDef[] = [
  {
    ...
    ex: [
      ...
      { n: "Incline DB Press",  b: [{s:4,r:12,w:"17.5kg"},{s:4,r:8,w:"22.5kg"},{s:4,r:6,w:"25kg"},{s:2,r:8,w:"18kg"}], rest:105, t:7 },
  ...
  },
  {
    ...
    ex: [
      ...
      { n: "Hammer Curl (standing, bilateral)", b: [{s:3,r:12,w:"10kg"},{s:3,r:10,w:"15kg"},{s:3,r:8,w:"15kg"},{s:2,r:10,w:"10kg"}], rest:75, t:7 },
      { n: "Reverse Pec Dec",        b: [{s:3,r:15,w:"Stack 3"},{s:3,r:12,w:"Progress"},{s:3,r:10,w:"Heavy"},{s:2,r:12,w:"Light"}], rest:75, t:7 },
    ]
  },
  {
    ...
    ex: [
      { n: "Incline DB Press",      b: [{s:3,r:12,w:"17.5kg"},{s:4,r:10,w:"22.5kg"},{s:4,r:8,w:"25kg"},{s:2,r:10,w:"18kg"}], rest:105, t:7 },
      { n: "Chest Supported Row",   b: [{s:3,r:12,w:"Calibrate"},{s:4,r:10,w:"Progress"},{s:4,r:8,w:"Heavy"},{s:2,r:10,w:"Light"}], rest:90, t:7 },
  ...
  },
  {
    ...
    ex: [
      { n: "Close Grip Bench Press",     b: [{s:3,r:12,w:"52.5kg"},{s:4,r:10,w:"55kg"},{s:4,r:8,w:"60kg"},{s:2,r:10,w:"45kg"}], rest:180, t:7 },
      ...
      { n: "Preacher Curl",              b: [{s:3,r:12,w:"10kg/side"},{s:3,r:10,w:"11.25kg/side"},{s:3,r:8,w:"11.25kg/side"},{s:2,r:10,w:"8.75kg/side"}], rest:90, t:7 },
  ...
  },
  {
    ...
    ex: [
      { n: "Barbell Back Squat",   b: [{s:4,r:12,w:"60kg"},{s:4,r:6,w:"72.5kg"},{s:4,r:5,w:"80kg"},{s:2,r:6,w:"55kg"}], rest:150, t:7 },
      { n: "Romanian Deadlift",    b: [{s:3,r:12,w:"60kg"},{s:3,r:8,w:"72.5kg"},{s:3,r:6,w:"80kg"},{s:2,r:8,w:"57.5kg"}], rest:120, t:7 },
      { n: "Leg Press",            b: [{s:3,r:12,w:"30kg/side"},{s:3,r:10,w:"35kg/side"},{s:3,r:8,w:"40kg/side"},{s:2,r:10,w:"25kg/side"}], rest:120, t:7 },
      { n: "Hack Squat",           b: [{s:3,r:12,w:"15kg/side"},{s:3,r:10,w:"Progress"},{s:3,r:8,w:"Heavy"},{s:2,r:10,w:"Light"}], rest:90, t:7 },
      ...
      { n: "Pallof Press",         b: [{s:3,r:10,w:"15kg"},{s:3,r:10,w:"20kg"},{s:3,r:10,w:"22.5kg"},{s:2,r:10,w:"12.5kg"}], rest:60, t:7 },
    ]
  },
];
