...
const DAYS: DayDef[] = [
  {
    ...
    ex: [
      { n: "Barbell OHP",       b: [{s:4,r:12,w:"30kg"},{s:4,r:10,w:"37.5kg"},{s:4,r:6,w:"42.5kg"},{s:2,r:8,w:"32.5kg"}], rest:120, t:8 },
  ...
  },
  {
    ...
    ex: [
      { n: "Conventional Deadlift",  b: [{s:4,r:12,w:"80kg"},{s:3,r:10,w:"90kg"},{s:4,r:4,w:"107.5kg"},{s:2,r:4,w:"85kg"}], rest:150, t:8 },
      { n: "Barbell Bent Over Row",  b: [{s:4,r:10,w:"50kg"},{s:3,r:10,w:"52.5kg"},{s:4,r:6,w:"60kg"},{s:2,r:8,w:"45kg"}], rest:120, t:8 },
      { n: "Pull Ups",               b: [{s:3,r:10,w:"Thicker band"},{s:3,r:10,w:"Thin Red Band"},{s:3,r:5,w:"Weighted"},{s:2,r:8,w:"Band"}], rest:90, t:8 },
      { n: "Hammer Curl (standing)", b: [{s:3,r:12,w:"10kg"},{s:3,r:14,w:"12.5kg"},{s:3,r:8,w:"15kg"},{s:2,r:10,w:"10kg"}], rest:75, t:8 },
  ...
  },
  {
    ...
    ex: [
      { n: "Machine Chest Press",   b: [{s:3,r:12,w:"17.5kg"},{s:3,r:10,w:"22.5kg"},{s:3,r:8,w:"Progress"},{s:2,r:10,w:"Light"}], rest:105, t:8 },
      { n: "Chest Supported Row",   b: [{s:3,r:12,w:"Calibrate"},{s:3,r:10,w:"27.5kg/side"},{s:4,r:8,w:"Heavy"},{s:2,r:10,w:"Light"}], rest:90, t:8 },
      { n: "Pec Dec",               b: [{s:3,r:15,w:"Stack 6"},{s:3,r:12,w:"Stack 7"},{s:3,r:10,w:"Stack 8"},{s:2,r:12,w:"Stack 5"}], rest:75, t:8 },
      { n: "Single Arm Pulldown",   b: [{s:3,r:12,w:"15kg / Stack 3"},{s:3,r:10,w:"27.5kg / Stack 6"},{s:3,r:8,w:"Heavy"},{s:2,r:10,w:"Light"}], rest:75, t:8 },
      { n: "Cable Lateral Raise",   b: [{s:3,r:15,w:"5kg / Stack 1"},{s:3,r:15,w:"5kg / Stack 1"},{s:3,r:10,w:"Heavy"},{s:2,r:12,w:"Light"}], rest:60, t:8 },
      { n: "Face Pull cable",       b: [{s:3,r:15,w:"Light"},{s:3,r:15,w:"Light"},{s:3,r:15,w:"Light"},{s:2,r:15,w:"Light"}], rest:60, t:7 },
    ]
  },
  {
    ...
    ex: [
      { n: "Close Grip Bench Press",     b: [{s:3,r:12,w:"52.5kg"},{s:3,r:10,w:"57.5kg"},{s:4,r:8,w:"60kg"},{s:2,r:10,w:"45kg"}], rest:180, t:8 },
      { n: "Overhead Tricep Ext rope",   b: [{s:3,r:12,w:"Stack 6"},{s:3,r:10,w:"Stack 7"},{s:3,r:8,w:"Stack 8"},{s:2,r:10,w:"Stack 5"}], rest:90, t:8 },
      { n: "Tricep Pushdown rope",       b: [{s:3,r:12,w:"Stack 4 / 20kg"},{s:3,r:10,w:"Stack 7"},{s:3,r:8,w:"Stack 6"},{s:2,r:10,w:"Stack 3"}], rest:90, t:8 },
      { n: "Bayesian Cable Curl",        b: [{s:3,r:12,w:"10kg"},{s:3,r:10,w:"20kg"},{s:3,r:10,w:"Heavy"},{s:2,r:12,w:"Light"}], rest:90, t:8 },
  ...
  },
  {
    ...
    ex: [
      ...
      { n: "Hack Squat",           b: [{s:3,r:12,w:"15kg/side"},{s:3,r:10,w:"17.5kg/side"},{s:3,r:8,w:"Heavy"},{s:2,r:10,w:"Light"}], rest:90, t:8 },
      { n: "Calf Raise",           b: [{s:3,r:15,w:"40kg/side"},{s:3,r:15,w:"42.5kg/side"},{s:3,r:10,w:"50kg/side"},{s:2,r:12,w:"32.5kg/side"}], rest:90, t:8 },
      ...
      { n: "Pallof Press",         b: [{s:3,r:10,w:"15kg"},{s:3,r:10,w:"20kg"},{s:3,r:10,w:"22.5kg"},{s:2,r:10,w:"12.5kg"}], rest:60, t:8 },
    ]
  },
];
